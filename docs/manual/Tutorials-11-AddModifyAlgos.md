...
### Add/Modify General Algo

Go to `engineai_rl/engineai_rl/algos`
- Basic algorithm (e.g. Ppo): create a folder named algorithm, add the logic and config of the algorithm
- Derivative algorithm (e.g. PpoAmp): Create a folder named Derivative algorithm in the original algo folder, and add the logic and config of the algorithm.
...
### Add/Modify Exp-specific Config

Go to `engineai_rl/engineai_rl/exps/{robot type}/{robot}/[{task}]`, add config
