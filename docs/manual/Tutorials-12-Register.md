...
Go to `engineai_rl_workspace/exps/{robot type}` and register in `{robot_name}.py`.
Registration includes exp_name, EnvClass, ObsClass, GoalClass, DomainRandsClass, RewardClass, env_config, Runner, AlgoClass, algo_config
